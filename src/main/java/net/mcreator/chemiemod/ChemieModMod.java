package net.mcreator.chemiemod;
...
@Mod("chemie_mod")
public class ChemieModMod {
	public static final Logger LOGGER = LogManager.getLogger(ChemieModMod.class);
	public static final String MODID = "chemie_mod";
